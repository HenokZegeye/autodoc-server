...
class MdxDocsReader(BaseReader):
    ...
    def markdown_to_docs(self, markdown_text: str, filename: str) -> List[Document]:
        ...
        short_path = filename.split(self.base_path)[-1]
        ...
        for line in lines:
            header_match = re.match(r"^#+\s", line) if current_code_block.strip() == "" else None # It should check if it is not part of code
            ...
            if header_match:
                ...
                if code_match and current_code_block: # End of the block I guess
